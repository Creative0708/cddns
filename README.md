...
Set `CLOUDFLARE_API_TOKEN` as an environment variable to get `cddns-server` to run. You can put this behind a reverse proxy and/or a URL prefix, just make sure it's accessible somewhere publicly.
